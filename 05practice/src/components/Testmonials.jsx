  ...
  return (
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
        ...
        <p class="leading-relaxed text-lg drop-shadow-lg">
          ...
          to stop it.” “If you don't make time for exercise, you'll probably
        ...
        ></span>
        <h2
          class="text-gray-900 font-medium title-font tracking-wider text-sm drop-shadow-xl"
        >
          Tejas Agrawal
        </h2>
