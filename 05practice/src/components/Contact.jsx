      ...
      <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        >
          ...
          <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            <div class="lg:w-1/2 px-6">
              ...
              <p class="mt-1">Koradi Naka, Nagpur Maharashtra 441111</p>
            </div>
            <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a class="text-indigo-500 leading-relaxed">iFitness@email.com</a>
              <h2
                class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4"
              >
                PHONE
              </h2>
              <p class="leading-relaxed">917-239-0187</p>
            </div>
          </div>
        </div>
        <div
        ...
        >
          ...
          <form action="./db.php" method="post">
            ...
            <button
              type="submit"
              class=" subBtn text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
            >
              Button
            </button>
          </form>
